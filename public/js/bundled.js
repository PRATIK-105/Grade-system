...
var qpForm = document.querySelector('.qp');
...
if (qpForm) {
  ...
  qpForm.addEventListener('submit', function (e) {
    ...
    var formData = new FormData(qpForm); // Create FormData object to collect form data

    var jsonObject = {};
    formData.forEach(function (value, key) {
      jsonObject[key] = value;
    });
    _axios.default.post('/grade-question-paper', jsonObject).then(function (response) {
